...
class ModelNetPairDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.noise_magnitude is not None:
            ref_points = random_jitter_points(ref_points, scale=0.02, noise_magnitude=self.noise_magnitude)
            src_points = random_jitter_points(src_points, scale=0.02, noise_magnitude=self.noise_magnitude)
